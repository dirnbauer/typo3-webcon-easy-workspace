...
final class SeedWorkspaceDiagnosticsCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->success('Seeded workspace diagnostic problems. Open Easy Workspace > Checks and diagnostics or run the diagnostic scanner before repairing/discarding them.');
        return Command::SUCCESS;
    }
